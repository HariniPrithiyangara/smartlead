...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 transition-colors duration-300">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-slate-200/80 dark:shadow-none border border-slate-100 dark:border-slate-700/50">
        <div className="px-8 pt-8 pb-6">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-slate-400 dark:text-slate-500 text-xs mt-1">Start managing your leads today</p>
          </div>
          ...
          <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
            ...
            <Link to="/login" className="text-[#14b8a6] dark:text-[#2dd4bf] font-medium hover:underline">
              Sign in
            </Link>
          </p>
        </div>
